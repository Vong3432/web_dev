...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Edit voucher Details</h2>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="validationform" data-parsley-validate="" novalidate="" action="{{ route('vouchers.update',$voucher->id) }}" method="POST">
                        @csrf
                        ...
                        @method('PUT')
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="text" name="code" value="{{ $voucher->code }}" placeholder="" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Product<span style="color: red">*</span></label>
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="text" name="model_id" value="{{ $voucher->model_id }}" placeholder="" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Data</label>
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="text" name="data" value="{{ $voucher->data }}" placeholder="" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Expires At</label>
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="number" name="expires_at" value="{{ $voucher->expires_at }}" placeholder="" class="form-control">
                                </div>
                            </div>
