...
/* $host = $url["host"] ?? env('DB_HOST', 'localhost');
$username = $url["user"] ?? env('DB_USERNAME', 'zrhun');
$password = $url["pass"] ?? env('DB_PASSWORD', '#Hun8201#Hun8201');
$database = $url["path"] ? substr($url["path"], 1) : env('DB_DATABASE', 'publications'); */
